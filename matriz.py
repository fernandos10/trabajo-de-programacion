...
# paso 7: RESULTADO DEL EJERCICIO
# ------------------------------------------------------
# Lista donde almacenaremos las sumas de cada fila
sumas_por_fila = []

# Bucle principal: recorre cada fila de la matriz
for fila in matriz:
    # La función sum() de Python suma todos los elementos de una lista
    suma_actual = sum(fila)
    
    # Agregamos la suma de la fila actual a la lista de resultados
    sumas_por_fila.append(suma_actual)
